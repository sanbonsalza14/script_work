...
// 나머지를 구하는 함수
(function mod(x, y) {
  console.log(x % y); // x를 y로 나눈 나머지를 출력
})(7, 3)
...
const myFunction1 = (s, y) => {
  //두 변수를 비교해서 y가 크면 두수를  바꾼다
  // 구조분해 할당 
  if(x > y) [x, y] = [y, x];
